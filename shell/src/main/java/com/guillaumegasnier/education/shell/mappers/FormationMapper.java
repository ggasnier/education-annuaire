...
public abstract class FormationMapper {
    ...
    public abstract FormationDTO toFormationDTO(CPFFormationDataset dataset);
    ...
    public List<ActionFormationDTO> toActionFormationDTO(@NonNull FormationType formationType) {
        List<ActionFormationDTO> dtos = new ArrayList<>();

        formationType.getAction().forEach(actionType -> {
