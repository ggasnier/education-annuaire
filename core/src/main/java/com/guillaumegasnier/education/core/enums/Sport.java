...
public enum Sport {
    ...
    RAID_MULTISPORTS("", "🏃🚴🛶", List.of("RAID MULTISPORTS", "RAID MULTISPORTS DE NATURE", "RAID MULTISPORT")),
    ...
    SHORT_TRACK("", "⛸️", List.of("SHORT TRACK", "SHORT-TRACK", "PISTE COURTE (SHORT TRACK)")),
    ...
    SNOWBOARD("", "🏂", List.of("SNOWBOARD", "SURF ALPIN", "SURF DES NEIGES")),
    ...
    TUMBLING("", "🤸", List.of("TUMBLING", "CULBUTE ACROBATIQUE (TUMBLING)")),
    ULTIMATE("", "🥏", List.of("ULTIMATE", "ULTIMATE (FRISBEE)", "ULTIME-PASSE (ULTIMATE)")),
    VOILE("", "⛵", List.of("VOILE")),
    ...
    ECHECS("Échecs", "", List.of("ÉCHECS", "ECHECS")),
    ...
    WATER_POLO("Water-polo", "🤽", List.of("WATER POLO", "WATER-POLO", "WATERPOLO"));
