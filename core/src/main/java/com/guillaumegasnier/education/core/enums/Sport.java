...
public enum Sport {
    ...
    FOOTBALL_AMERICAIN("Football américain", "🏈", List.of("FOOTBALL AMERICAIN")),
    ...
    GYMNASTIQUE("Gymnastique", "🤸", List.of("GYMNASTIQUE")),
    ...
    HALTEROPHILIE("", "🏋️", List.of("HALTÉROPHILIE")),
    ...
    SAUVETAGE_COTIER("Sauvetage côtier", "🛟", List.of("SAUVETAGE CÔTIER")),
    ...
    SKI_DE_FOND("Ski de fond", "🎿", List.of("SKI DE FOND")),
