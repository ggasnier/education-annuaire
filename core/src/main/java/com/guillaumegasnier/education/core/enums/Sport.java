...
public enum Sport {
    ...
    TRAIL("Trail", "🌲", List.of("TRAIL", "COURSE EN PLEINE NATURE")),
    ...
    JU_JITSU("", "🥋", List.of("JU-JITSU", "JIU-JITSU")),
    KARATE("", "🥋", List.of("KARATE", "KARATÉ")),
    LUTTE("", "🤼", List.of("LUTTE")),
    ...
    PLONGEE("", "🤿", List.of("PLONGEE", "PLONGÉE")),
    ROLLER("Roller", "🛼", List.of("ROLLER", "ROLLER SKATING", "ROLLER ET SKATEBOARD")),
    ROLLER_HOCKEY("Roller hockey", "🛼", List.of("ROLLER HOCKEY")),
    RAID_MULTISPORTS("", "🏃🚴🛶", List.of("RAID MULTISPORTS", "RAID MULTISPORTS DE NATURE")),
    ...
    SAUVETAGE_COTIER("Sauvetage côtier", "🛟", List.of("SAUVETAGE CÔTIER", "SAUVETAGE AQUATIQUE", "SURF ET SAUVETAGE CÔTIER")),
    SAUVETAGE_SPORTIF("Sauvetage sportif", "🛟", List.of("SAUVETAGE SPORTIF", "NATATION SPORTIVE ET SAUVETAGE")),
    SHORT_TRACK("", "⛸️", List.of("SHORT TRACK", "SHORT-TRACK")),
    ...
    SNOWBOARD("", "🏂", List.of("SNOWBOARD", "SURF ALPIN")),
    ...
    TAEKWONDO("", "🥋", List.of("TAEKWONDO", "TAE KWON DO")),
    ...
    VTT("", "🚵", List.of("VTT", "VTT ET CYCLISME")),
    KITESURF("Kitesurf", "", List.of("KITESURF")),
    PROVENCAL("Jeu provençal", "", List.of("PÉTANQUE ET JEU PROVENÇAL")),
    ECHECS("Échecs", "", List.of("ÉCHECS")),
    LONGUE_PAUME("Longue paume", "", List.of("LONGUE PAUME")),
    KARTING("Karting", "", List.of("KARTING")),
    SPORT_ADAPTE_MULTISPORTS("", "", List.of("SPORT ADAPTÉ MULTISPORTS")),
