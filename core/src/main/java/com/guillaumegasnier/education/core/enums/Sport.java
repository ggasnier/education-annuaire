...
public enum Sport {
    ...
    ACTIVITES_PHYSIQUES("Activités physiques pour tous", "🌲", List.of("ACTIVITÉS PHYSIQUES POUR TOUS")),
    ...
    CHAR_A_VOILES("Char à voiles", "⛵", List.of("CHAR A VOILES", "CHAR À VOILE")),
    ...
    BREAK("Breakdance", "💃", List.of("BREAK")),
    ...
    CIRCUIT_TRAINING("Circuit training", "💪", List.of("FITNESS EN CIRCUIT TRAINING")),
    ...
    NATATION_HANDISPORT("Natation handisport", "🏊", List.of("PARANATATION")),
    PARASPORT("Parasport", "♿", List.of("PARASPORT")),
